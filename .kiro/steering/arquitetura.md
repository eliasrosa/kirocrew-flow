...
Quando o reviewer pede mudança, o motor adiciona `crewflow:review-fail` à issue
...
3. Commita e faz push (o novo SHA invalida o lock interno `crewflow:reviewed` automaticamente)
