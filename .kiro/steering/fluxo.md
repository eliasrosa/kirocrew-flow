...
| `run_review_approved` | `flow:review-approved` | `MERGE_PR` — merge squash -> `flow:qa-waiting` | 120s (2 min) |
| `run_qa_approved` | `flow:qa-approved` | `MERGE_PR` — merge final -> `flow:done` | 120s (2 min) |
