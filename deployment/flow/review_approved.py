"""KiroCrew Flow — cron de merge squash pós-review.

Processa PRs em ``flow:review-approved`` e executa o merge squash automático,
...
def run(ctx: object) -> None:
    ...
    automático, movendo a issue para ``flow:qa-waiting``. Intervalo curto
    recomendado: 120s.
